...
you should place your code here."
  ...
  (setq neo-theme 'icons
        ...
        monokai-background "#2C292D"
        monokai-comments "#2B272C"
        monokai-emphasis "#2C292D"
        monokai-highlight "#FFB269"
        monokai-highlight-alt "#66D9EF"
        monokai-highlight-line "#1B1D1E"
        monokai-line-number "#2B272C"
        monokai-blue "#AB9DF2"
        monokai-cyan "#78DCE8"
  ...
  ;; (add-hook 'prog-mode-hook 'highlight-beyond-fill-column)  ; Not installed.
  ...
  (define-key evil-normal-state-map (kbd "M-e") 'helm-find-files)
  ...
  (define-key evil-normal-state-map (kbd "M-n") 'split-window-below-and-focus)
  (define-key evil-normal-state-map (kbd "M-N") 'split-window-right-and-focus)
  (define-key evil-normal-state-map (kbd "M-5") (lambda () (interactive) (evil-resize-window 10)))
